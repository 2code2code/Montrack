package com.montrack.Montrack.config;

import com.montrack.Montrack.auth.service.impl.UserDetailsServiceImpl;
...
//                .cors(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/v1/users/setup-pin").permitAll();
